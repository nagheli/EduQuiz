...
public class HistQ2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hist_q2);
        ...
        nextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // create a new intent to open the HistQ3 activity
                if(optionFourQ1.isChecked() || optionTwoQ1.isChecked() || optionThreeQ1.isChecked()){
                    answerPoints = answerPoints + 0;
                }
                else if (optionTwoQ1.isChecked()&& optionFiveQ1.isChecked()) {
                    answerPoints++;
                }
    ...
    private void sendData() {
        ...
        Intent histQ3Intent = new Intent(HistQ2.this, HistQ3.class);
        histQ3Intent.putExtra("Score", score);

        //START SECOND ACTIVITY
        this.startActivity(histQ3Intent);
    }
