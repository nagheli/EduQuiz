...
public class HistQ3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hist_q3);
        ...
        nextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // create a new intent to open the HistQ4 activity
                if(optionFiveQ1.isChecked() || optionThreeQ1.isChecked()|| optionOneQ1.isChecked()){
                    answerPoints = answerPoints + 0;
                }
                else if (optionTwoQ1.isChecked() && optionFourQ1.isChecked()) {
                    answerPoints++;
                }
    ...
    private void sendData() {
        ...
        Intent histQ4Intent = new Intent(HistQ3.this, HistQ4.class);
        histQ4Intent.putExtra("Score", score);

        //START SECOND ACTIVITY
        this.startActivity(histQ4Intent);
    }
