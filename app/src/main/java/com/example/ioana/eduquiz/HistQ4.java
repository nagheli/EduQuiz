...
public class HistQ4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hist_q4);
        ...
        nextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (optionOneQ1.isChecked() && optionFiveQ1.isChecked()) {
                    answerPoints++;
                }
    ...
    private void sendData() {
        ...
        Intent histSubmitQ2Intent = new Intent(HistQ4.this, HistSubmit.class);
        histSubmitQ2Intent.putExtra("Score", score);

        //START SECOND ACTIVITY
        this.startActivity(histSubmitQ2Intent);
    }
