...
public class NatSubmit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nat_submit);
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // create a new intent to open the Nature activity

                Intent intent = new Intent(NatSubmit.this,Nature.class);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT,getString(R.string.category2));
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(NatSubmit.this,MainActivity.class);
                startActivity(intent);
            }
        });
